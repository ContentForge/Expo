...
public class NotCompletedParagraphCondition extends Condition {

    public NotCompletedParagraphCondition() {
        super("not_completed");
    }
    ...
    public Result handle(PlayerData playerData, String[] args) throws IndexOutOfBoundsException {
        ...
        return new Result((paragraph.isQuest()? "Не выполнено задание" : "Не изучена глава") + " '"+paragraph.getName()+"'", playerData.isCompletedParagraph(paragraph));
    }
